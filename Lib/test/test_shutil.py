...
from shutil import (make_archive,
                    ...
                    SameFileError, _GiveupOnFastCopy, chdir_context, umask_context)
import tarfile
import zipfile
try:
    import posix
...
class PublicAPITests(unittest.TestCase):
    ...
    def test_module_all_attribute(self):
        ...
        target_api = ['copyfileobj', 'copyfile', 'copymode', 'copystat',
                      ...
                      'get_terminal_size', 'SameFileError', 'chdir_context', 'umask_context']
...
class TestChdirContext(unittest.TestCase):
    ...
    def test_reentrant(self):
        ...
        chdir1, chdir2 = chdir_context(target1), chdir_context(target2)
