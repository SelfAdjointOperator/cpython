...
.. function:: chdir(path)
   ...
   .. deprecated:: 3.14
      This context manager has been moved to :class:`shutil.chdir_context` due to its
...
:func:`suppress`, :func:`redirect_stdout`, and :class:`shutil.chdir_context`. Here's a very
